...
- Applying deep learning and LLM-based architectures
...
- Applied machine learning (classification & forecasting)
- Experiment design and A/B testing
- Deep learning systems (CNNs)
- Retrieval-Augmented Generation (RAG)
- AI agents with tool use and reasoning
- Model evaluation, tradeoffs, and business impact
- Engineering best practices (pipelines, modularity, documentation)
